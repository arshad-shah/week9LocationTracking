package com.example.week9locationtracking;
    ...
    private void getAddressFromLocation(double latitude, double longitude) {
        ...
        try {
            ...
            if (addresses.size() > 0) {
                ...
                houseName.setText(fetchedAddress.getAddressLine(0));
                address.setText(fetchedAddress.getLocality());

            } else {
                address.setText("Searching Current Address");
            }
